...
<div id="tool">
    ...
    <table>
        <tr>
            ...
            <?php if($_SESSION[C('USER_AUTH_KEY')] > 0 and $_SESSION[C('USER_AUTH_KEY')] < 3): ?><td><a href="#" id= "aaa1" class="easyui-linkbutton"  onclick='show_add()' data-options="iconCls:'icon-standard-folder-page',plain:true">添加</a><a href="#" class="easyui-linkbutton"  onclick='dele()' data-options="iconCls:'icon-standard-page-white-delete',plain:true">删除</a><a href="#" class="easyui-linkbutton"  onclick='show_edit()' data-options="iconCls:'icon-standard-application-edit',plain:true">编辑</a><td><div class="datagrid-btn-separator"></div></td><?php endif; ?>
            <td><a href="#"  class="easyui-linkbutton"   onclick="excel()" data-options="iconCls:'icon-standard-page-white-excel',plain:true">导出</a><a href="#" class="easyui-linkbutton"  onclick="view()" data-options="iconCls:'icon-standard-application-view-gallery',plain:true">查看</a><a href="#" class="easyui-linkbutton"  onclick="show_pinlun()" data-options="iconCls:'icon-standard-building-add',plain:true">评论</a></td>
            <td><div class="datagrid-btn-separator"></div></td>
            <td><a href="#" class="easyui-linkbutton"  onclick="reload()" data-options="iconCls:'icon-standard-arrow-refresh',plain:true">刷新</a></td>
            <td><div class="datagrid-btn-separator"></div></td>
            <td>
            <div style="float:right;">
                <input  id='searchbox' class="easyui-searchbox" data-options="" style="width:400px;">
                </input>
            </div>
            <div id="mm" style="width:400px">
                <div data-options="name:'miaoshu',iconCls:'icon-standard-table-edit',selected:true">
                    问题描述
                </div>
                <div data-options="name:'creattime',iconCls:'icon-standard-date-magnify'" >
                    日期
                </div>
                <div data-options="name:'cx',iconCls:'icon-standard-table-multiple'" >
                    车型
                </div>

                <div data-options="name:'laiyuan',iconCls:'icon-standard-tag-blue'" >
                    来源
                </div>
                <div data-options="name:'yuanyin',iconCls:'icon-standard-sum'">
                    原因分析
                </div>
                <div data-options="name:'zhenggai',iconCls:'icon-standard-table-edit'">
                    问题整改
                </div>
...
<style>
    ...
    .add-dialog{
      width: 728px; height: 608px; padding: 0px; overflow: hidden; 
      
    }
  
</style>
<div id="add" class="easyui-dialog add-dialog" title="&nbsp;&nbsp;添加定额工时" data-options="iconCls:'icon-standard-folder-page',buttons:'#dlg-add',closed:true,resizable:false,modal:false,closable:true">
    <form id="add_form" action="/timer/index.php/Home/Quality/add_quality" enctype="multipart/form-data" method="post" >
        <table width="100%" cellspacing="0" class="table_form">
            <tr>
                ...
                <td colspan="3">
                <div>
                    <label for="cj" style="margin:0 20px 0 0;">车间：
                    <select id="cj" class="easyui-combobox" name="cj" data-options="editable:false,panelHeight:'auto'" style="width: 100px;">
                        <option value="底盘车间" select="true">底盘车间</option>
                        <option value="内饰车间">内饰车间</option>
                        <option value="试制一">试制一</option>
                        <option value="试制二">试制二</option>
                        <option value="调试">调试</option>
                        <option value="其他">其他</option>
                    </select>
                </label>
                  <label for="bz" style="margin:0 20px 0 0;">班组：
                    <select id="bz" class="easyui-combobox" name="bz" data-options="editable:false,panelHeight:'auto'" style="width: 100px;">
                        <option value="底盘车间" select="true">底盘车间</option>
                        <option value="内饰车间">内饰车间</option>
                        <option value="试制一">试制一</option>
                        <option value="试制二">试制二</option>
                  ...
                  <label for="gw" style="margin:0 20px 0 0;">工位：
                    <select id="gw" class="easyui-combobox" name="gw" data-options="editable:false,panelHeight:'auto'" style="width: 100px;">
                        <option value="底盘车间" select="true">底盘车间</option>
                        <option value="内饰车间">内饰车间</option>
                        <option value="试制一">试制一</option>
                        <option value="试制二">试制二</option>
                    ...
                    <label for="creattime">创建日期：
                        <input id="creattime" name="creattime" type="text" class="easyui-datebox" data-options="editable:false" style="width: 178px">
                        </input> </label> -->
                </div>
              </td> 
            </tr>
            <tr>
                ...
                <div>
                    <label>装配内容：
                        <input id="cx" name="cx" class="easyui-validatebox" style="width: 80%" />
                    </label>
                    <!-- &nbsp;&nbsp;&nbsp;&nbsp;
                    <label for="creattime">创建日期：
                        <input id="creattime" name="creattime" type="text" class="easyui-datebox" data-options="editable:false" style="width: 178px">
                ...
                <div style="padding:10px 0 0 0 ">
                    ...
                    <label for="gygs">工艺工时：
                          <input style="width:80px;margin:0 20px 0 0;" type="number" name="gygs" value="" id="gygs"/>
                </label>
                     <label for="degs">定额工时：
                          <input style="width:80px;margin:0 20px 0 0;" type="number" name="degs" value="" id="degs"/>
                </label>
                </div></td>
            </tr>
            <tr>
                ...
                <td>
                  ...
                  <span class="searchbox" >
                      <a class="searchbox-menu m-btn l-btn l-btn-plain" href="javascript:void(0)" style="height: 20px;">
                       
                    <input type="text" class="searchbox-text searchbox-prompt" name="miaoshu" style="width: 286px; height: 20px; line-height: 20px;color:#000">
                    <span>
                        <a id="btn" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true"></a>
                ...
                <br />
                <!-- <div id="miaoshu_contentwordage"></div></td> -->
                <a id="btn" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-del',plain:true">亲哥哥是</a>
            </tr>
            <tr>
                <th width="80">原因分析</th>
                <td>                <textarea name="yuanyin" id="yuanyin_content" style="width: 98%; height: 46px;" onkeyup=""></textarea>
                <br />
                <div id="yuanyin_contentwordage"></div></td>
            </tr>
            <tr>
                <th width="80">问题整改</th>
                <td>                <textarea name="zhenggai" id="zhenggai_content" style="width: 98%; height: 46px;" onkeyup=""></textarea>
                <br />
                <div id="zhenggai_contentwordage"></div></td>
            </tr>
...
<script type="text/javascript">
	$('#dg').datagrid({
	url : '/timer/index.php/Home/Degs/read',
	toolbar : '#tool',
	pagination : true,
	fit : true,
	width : function() {
